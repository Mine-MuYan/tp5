<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"C:\xampp\htdocs\tp5\public/../application/index\view\index\index.html";i:1504841679;s:69:"C:\xampp\htdocs\tp5\public/../application/index\view\public\head.html";i:1504839682;s:71:"C:\xampp\htdocs\tp5\public/../application/index\view\public\footer.html";i:1483796785;}*/ ?>
...
<div id="header_wrap">
    <div id="header">
        ...
        <div id="navi">
            <ul id="jsddm">
                <li>
                    <a class="navi_home" href="<?php echo url('index/index'); ?>">首页</a>
                </li>
                <?php if(is_array($cateres) || $cateres instanceof \think\Collection || $cateres instanceof \think\Paginator): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                <li>
                    <!--<a <?php if($cate['children'] != 0): ?> class="havechild" <?php endif; ?> href="http://127.0.0.1/bick/public/index.php/index/<?php if($cate['type'] == 1): ?>artlist<?php elseif($cate['type'] == 3): ?>imglist<?php else: ?>page<?php endif; ?>/index/cateid/<?php echo $cate['id']; ?>"><?php echo $cate['catename']; ?></a><?php if($cate['children'] != 0): ?>-->
                    <ul>
                        <?php foreach ($cate['children'] as $k2 => $v2):?>
                        <li>
                            <!--<a href="http://127.0.0.1/bick/public/index.php/index/<?php if($v2['type'] == 1): ?>artlist<?php elseif($v2['type'] == 3): ?>imglist<?php else: ?>page<?php endif; ?>/index/cateid/<?php echo $v2['id']; ?>"><?php echo $v2['catename'];?></a>-->
                        </li>
                        <?php endforeach;?>
                    </ul>
                    <?php endif; ?>
                ...
                <div style="float: left;">
                    <form name="formsearch" action="<?php echo url('search/index'); ?>" method="get">
                        <input name="keywords" type="text"
                               style="background-color: #000000;padding-left: 10px; font-size: 12px;font-family: 'Microsoft Yahei'; color: #999999;height: 29px; width: 160px; border: solid 1px #666666; line-height: 28px;"
                               id="go" value="在这里搜索..." onfocus="if(this.value=='在这里搜索...'){this.value='';}"
        ...
        <div class="xh_h_show_in">
            ...
            <div id="picshow_right">
                <a href="/life/416.html" target="_blank">
                    <img src="__INDEX__/images/1-140206160415Y6.jpg" alt="COACH再度携手王力宏 踩单车演" width="255px" height="420px">
                </a>

                <div id="picshow_right_cover" onclick="goanewurl()" style="cursor:pointer;position:absolute;top:495px;font-size:14px;width:213px;height:45px;line-height:45px;padding-left:42px;color:#ffffff;zoom:1;background-image:url(__INDEX__/images/focus-left-bg.png); background-repeat:no-repeat; background-color:#01A1ED;">
            ...
            <div class="xh_area_h_3">
                ...
                <div class="xh_post_h_3 ofh">
                    ...
                    <div class="xh_265x265">
                        <a target="_blank" href="<?php echo url('Article/index',array('artid'=>$article['id'])); ?>"
                           title="<?php echo $article['title']; ?>">
                            <img src="<?php echo $article['thumb']; ?>" alt="<?php echo $article['title']; ?>" height="240" width="400">
                        </a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="xh_post_h_3_entry ofh"><?php echo $article['desc']; ?></div>
                    <!--</div>-->
                    <div class="b">
    ...
    <div id="xh_sidebar">
            ...
            <ul id="ulHot">
                ...
                <li style="border-bottom:dashed 1px #ccc;height:70px; margin-bottom:15px;">
                    <div style="float:left;width:85px;height:55px; overflow:hidden;">
                        <a href="<?php echo url('Article/index',array('artid'=>$article['id'])); ?>" target="_blank">
                            <img src="<?php echo $article['thumb']; ?>" width="83" title="<?php echo $article['title']; ?>"/>
                        </a>
                    </div>
                    <div style="float:right;width:145px;height:52px; overflow:hidden;">
                        <a href="<?php echo url('Article/index',array('artid'=>$article['id'])); ?>" target="_blank" title="<?php echo $article['title']; ?>"><?php echo $article['title']; ?></a>
                    </div>
                </li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        ...
        <div class="widget links">
            ...
            <ul>
                ...
                <li>
                    <a href="<?php if(strpos($link['url'], 'http://')!== 0){echo 'http://'.$link['url'];}else{echo $link['url'];} ?>" target='_blank'><?php echo $link['title']; ?></a>
                </li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <div class="clear">
...
<script type="text/javascript">
    ...
    $("#next-page").hover(function () {
        $(this).attr("src", "__INDEX__/images/next02.png");
    }, function () {
        $(this).attr("src", "__INDEX__/images/next01.png");
    });
    $("#last-page").hover(function () {
        $(this).attr("src", "__INDEX__/images/last02.png");
    }, function () {
        $(this).attr("src", "__INDEX__/images/last01.png");
    });
    ...
    <div class="l">
        <ul id="menu-sitemap" class="menu">
            ...
            <li class="menu-item menu-item-type-custom menu-item-object-custom">
                <!--<a target="_blank" href="http://127.0.0.1/bick/public/index.php/index/<?php if($cate['type'] == 1): ?>artlist<?php elseif($cate['type'] == 3): ?>imglist<?php else: ?>page<?php endif; ?>/index/cateid/<?php echo $cate['id']; ?>"><?php echo $cate['catename']; ?></a><?php if($cate['children'] != 0): ?>-->
                <ul class="sub-menu">
                    <?php foreach ($cate['children'] as $k2 => $v2):?>
